...
public class EssenciaLightningParticle extends SingleQuadParticle {
    private static final Random RANDOM = new Random();
    private final SpriteSet sprites;

    protected EssenciaLightningParticle(ClientLevel worldIn, double x, double y, double z, double motionX, double motionY, double motionZ, SpriteSet spriteWithAge) {
        super(worldIn, x, y, z, 0.5D - RANDOM.nextDouble(), motionY, 0.5D - RANDOM.nextDouble(), spriteWithAge.first());
