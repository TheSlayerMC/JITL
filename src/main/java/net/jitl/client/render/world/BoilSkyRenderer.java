...
public class BoilSkyRenderer {
    ...
    public void render(int ticks, float partialTicks, PoseStack matrixStack, ClientLevel world) {
        ...
        if (sunRiseRGBA != null) {
            ...
            matrixStack.mulPose(Axis.ZP.rotationDegrees(celestialAngle));
        ...
        matrixStack.mulPose(Axis.XP.rotationDegrees(world.getTimeOfDay(partialTicks) * 120.0F));
    ...
    private void createLightSky() {
        ...
        BufferBuilder.RenderedBuffer ren = buildSkyDisc(bufferbuilder, 16.0F);
        drawSkyHemisphere(bufferbuilder, 16.0F);
        bufferbuilder.end();
        this.skyBuffer.upload(ren);
    }
