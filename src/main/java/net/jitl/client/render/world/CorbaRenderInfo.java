...
public class CorbaRenderInfo extends JDimensionSpecialEffects implements CustomSkyboxRenderer, CustomCloudsRenderer {
    ...
    public boolean renderClouds(LevelRenderState levelRenderState, Vec3 camPos, CloudStatus cloudStatus, int cloudColor, float cloudHeight, int cloudRange, Matrix4fc modelViewMatrix) {
        new JCloudRenderer(JITL.rl("textures/environment/corba_clouds.png")).render(cloudColor, cloudStatus, cloudHeight, cloudRange, camPos, levelRenderState.gameTime, 10F);
