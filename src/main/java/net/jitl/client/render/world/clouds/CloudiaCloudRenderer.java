...
public class CloudiaCloudRenderer {
...
//                        .setTextureState(new RenderStateShard.TextureStateShard(JITL.rl("textures/environment/cloudia_clouds.png"), TriState.FALSE, false))
