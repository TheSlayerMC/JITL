...
public class KoriteShieldRenderer implements SpecialModelRenderer<DataComponentMap> {
    ...
    public KoriteShieldRenderer(MaterialSet materials, ShieldModel model) {
        this.model = model;
    ...
    public void submit(@Nullable DataComponentMap typedDataComponents, @NotNull ItemDisplayContext itemDisplayContext, PoseStack pose, SubmitNodeCollector submitNodeCollector, int i, int i1, boolean b, int i2) {
        ...
        Material material = new Material(Sheets.SHIELD_SHEET, JITL.rl("textures/shield/" + "korite" + "_shield.png"));
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakingContext c) {
            return new KoriteShieldRenderer(c.materials(), new ShieldModel(c.entityModelSet().bakeLayer(ModelLayers.SHIELD)));
        }
