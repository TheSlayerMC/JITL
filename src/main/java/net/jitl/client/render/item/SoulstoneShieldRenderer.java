...
public class SoulstoneShieldRenderer implements SpecialModelRenderer<DataComponentMap> {
    ...
    public SoulstoneShieldRenderer(MaterialSet materials, ShieldModel model) {
        this.model = model;
    ...
    public void submit(@Nullable DataComponentMap typedDataComponents, @NotNull ItemDisplayContext itemDisplayContext, PoseStack pose, SubmitNodeCollector submitNodeCollector, int i, int i1, boolean b, int i2) {
        ...
        Material material = new Material(Sheets.SHIELD_SHEET, JITL.rl("textures/shield/" + "soulstone" + "_shield.png"));
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakingContext c) {
            return new SoulstoneShieldRenderer(c.materials(), new ShieldModel(c.entityModelSet().bakeLayer(ModelLayers.SHIELD)));
        }
