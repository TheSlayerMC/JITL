...
public class RenderEntity2D<T extends Entity> extends EntityRenderer<T> {
    ...
    public RenderEntity2D(EntityRendererProvider.Context context, ResourceLocation texture) {
        super(context);
    ...
    public RenderEntity2D<T> scale(float scale) {
        this.scale = scale;
        return this;
    }

    public RenderEntity2D<T> fullbright(boolean fullbright) {
        this.fullBright = fullbright;
        return this;
    }

    public RenderEntity2D<T> projectile(boolean projectile) {
