...
public class RenderEntitys {
    ...
    public static void registerAnimationRenderers() {
        ...
        EntityRenderers.register(JEntities.ILLAGER_MECH_TYPE.get(), renderer -> new AnimatedMonsterRenderer<>(renderer, new AnimatedMonsterModel<>("illager_mech", JDimension.OVERWORLD), 1F, 2F));
