...
public class OverseerElderSpawnerEntity extends JSpawnerEntity {
    ...
    private final DarkNotNeededSpawner spawner = new DarkNotNeededSpawner() {
        ...
        public void broadcastEvent(@NotNull Level l, @NotNull BlockPos pos, int id) {
            l.blockEvent(pos, JBlocks.OVERSEER_ELDER_SPAWNER.get(), id, 0);
        }
        ...
        public Either<BlockEntity, Entity> getOwner() {
            return Either.left(OverseerElderSpawnerEntity.this);
        }
    };

    public OverseerElderSpawnerEntity(BlockPos pPos, BlockState pBlockState) {
        super(JBlockEntities.OVERSEER_ELDER_SPAWNER.get(), pPos, pBlockState);
    }
