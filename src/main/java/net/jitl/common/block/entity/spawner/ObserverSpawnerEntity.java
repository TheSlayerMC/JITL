...
public class ObserverSpawnerEntity extends JSpawnerEntity {
    ...
    private final DarkNotNeededSpawner spawner = new DarkNotNeededSpawner() {
        ...
        public void broadcastEvent(@NotNull Level l, @NotNull BlockPos pos, int id) {
            l.blockEvent(pos, JBlocks.OBSERVER_SPAWNER.get(), id, 0);
        }
        ...
        public Either<BlockEntity, Entity> getOwner() {
            return Either.left(ObserverSpawnerEntity.this);
        }
    };

    public ObserverSpawnerEntity(BlockPos pPos, BlockState pBlockState) {
        super(JBlockEntities.OBSERVER_SPAWNER.get(), pPos, pBlockState);
    }
