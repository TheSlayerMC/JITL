...
public class OverseerSpawnerEntity extends JSpawnerEntity {
    ...
    public OverseerSpawnerEntity(BlockPos pPos, BlockState pBlockState) {
        super(JBlockEntities.OVERSEER_SPAWNER.get(), pPos, pBlockState);
    }
