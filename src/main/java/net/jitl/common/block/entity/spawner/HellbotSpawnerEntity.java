...
public class HellbotSpawnerEntity extends JSpawnerEntity {
    ...
    private final DarkNotNeededSpawner spawner = new DarkNotNeededSpawner() {
        ...
        public void broadcastEvent(@NotNull Level l, @NotNull BlockPos pos, int id) {
            l.blockEvent(pos, JBlocks.HELLBOT_SPAWNER.get(), id, 0);
        }
        ...
        public Either<BlockEntity, Entity> getOwner() {
            return Either.left(HellbotSpawnerEntity.this);
        }
    };

    public HellbotSpawnerEntity(BlockPos pPos, BlockState pBlockState) {
        super(JBlockEntities.HELLBOT_SPAWNER.get(), pPos, pBlockState);
    }
