...
public class EscapedConvict extends JVillagerEntity {
    ...
    public EscapedConvict(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.escaped_convict.idle");
