...
public class Observer extends JMonsterEntity {

    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(Observer.class, EntityDataSerializers.BYTE);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new Observer.ObserverAttackGoal(this));
    ...
    static class ObserverAttackGoal extends Goal {
        private final Observer blaze;
        private int attackStep;
        private int attackTime;
        private int lastSeen;

        public ObserverAttackGoal(Observer pBlaze) {
            this.blaze = pBlaze;
