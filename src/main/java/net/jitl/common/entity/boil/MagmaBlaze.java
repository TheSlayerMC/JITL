...
public class MagmaBlaze extends JMonsterEntity {

    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(MagmaBlaze.class, EntityDataSerializers.BYTE);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new MagmaBlaze.MagmaBlazeAttackGoal(this));
    ...
    static class MagmaBlazeAttackGoal extends Goal {
        private final MagmaBlaze blaze;
        private int attackStep;
        private int attackTime;
        private int lastSeen;

        public MagmaBlazeAttackGoal(MagmaBlaze pBlaze) {
            this.blaze = pBlaze;
