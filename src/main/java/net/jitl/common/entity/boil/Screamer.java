...
public class Screamer extends JFlyingEntity {

    public Screamer(EntityType<? extends JFlyingEntity> pEntityType, Level pLevel) {
    ...
    public static boolean checkSpawn(EntityType<Screamer> entity, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
