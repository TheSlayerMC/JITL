...
public class Shimmerer extends JFlyingEntity {
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.SHIMMERER_HEALTH)
    ...
    public static boolean checkSpawn(EntityType<Shimmerer> entity, ServerLevelAccessor level, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
