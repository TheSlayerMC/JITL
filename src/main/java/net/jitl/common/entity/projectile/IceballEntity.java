...
public class IceballEntity extends ThrowableProjectile {
    ...
    public IceballEntity(Level world, LivingEntity thrower) {
        super(JEntities.ICEBALL_TYPE.get(), thrower, world);
    }
    ...
    protected void onHitEntity(@NotNull EntityHitResult res) {
        ...
        if(entity instanceof LivingEntity && entity.hurt(this.damageSources().thrown(this, this.getOwner()), getDamage())) {
            MobEffectInstance effectInstance = new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 60);
