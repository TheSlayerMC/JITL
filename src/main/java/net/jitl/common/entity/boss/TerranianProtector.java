...
public class TerranianProtector extends JBossEntity implements RangedAttackMob {
    ...
    private final BossBarRenderer BOSS_BAR = new BossBarRenderer(this, JITL.rl("textures/gui/bossbars/terranian_protector.png"));
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.TERRANIAN_PROTECTOR_HEALTH)
                .add(Attributes.KNOCKBACK_RESISTANCE, MobStats.TERRANIAN_PROTECTOR_KNOCKBACK_RESISTANCE)
    ...
    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.terranian_protector.idle");
    ...
    protected @Nullable BossCrystal.Type getDeathCrystalType() {
        return BossCrystal.Type.TERRANIA;
    }

    @Override
    public ResourceLocation lootTable() {
        return JLootTables.TERRANIAN_PROTECTOR_CRYSTAL;
    }
