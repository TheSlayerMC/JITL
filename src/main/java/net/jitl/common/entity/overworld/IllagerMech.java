...
public class IllagerMech extends JMonsterEntity {
    ...
    private final RawAnimation MOVING = RawAnimation.begin().thenLoop("animation.illager_mech.walk");
    private final RawAnimation ATTACK = RawAnimation.begin().thenLoop("animation.illager_mech.throw");
    private final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.illager_mech.idle");
