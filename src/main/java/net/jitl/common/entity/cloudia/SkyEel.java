...
public class SkyEel extends JFlyingEntity {
    ...
    public static AttributeSupplier createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, MobStats.SKY_EEL_HEALTH)
    ...
    public static boolean checkSpawn(EntityType<SkyEel> entity, ServerLevelAccessor level, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
