...
public class MobStats {
    ...
    public static final double BURNING_LIGHT_HEALTH = 45;
    public static final double BURNING_LIGHT_DAMAGE = 8;

    public static final double EXPOSED_FLAME_HEALTH = 45;
    public static final double EXPOSED_FLAME_DAMAGE = 9;
    ...
    public static final double HELLWING_HEALTH = 40;
    public static final double HELLWING_DAMAGE = 8;

    public static final double MAGMA_BLAZE_HEALTH = 40;
    public static final double MAGMA_BLAZE_DAMAGE = 8;

    public static final double OBSERVER_HEALTH = 58;
    public static final double OBSERVER_DAMAGE = 8;

    public static final double SCREAMER_HEALTH = 48;
    public static final double SCREAMER_DAMAGE = 9;

    // =======================================================
    // ===================== CLOUDIA MOBS ====================
    // =======================================================

    public static final double AERO_LOTUS_HEALTH = 75;
    public static final double AERO_LOTUS_MOVEMENT_SPEED = 0;

    public static final double CLOUD_GHOST_HEALTH = 75;
    public static final double CLOUD_GHOST_DAMAGE = 18;

    public static final double CLOUD_GUARDIAN_HEALTH = 25;
    public static final double CLOUD_GUARDIAN_FOLLOW_RANGE = 25;

    public static final double STARLIGHT_GOLEM_HEALTH = 75;
    public static final double STARLIGHT_GOLEM_DAMAGE = 17;

    public static final double STARLIGHT_TRANSPORTER_HEALTH = 75;
    public static final double STARLIGHT_TRANSPORTER_DAMAGE = 18;

    public static final double STARLIGHT_WALKER_HEALTH = 75;
    public static final double STARLIGHT_WALKER_DAMAGE = 17;

    public static final double SKY_EEL_HEALTH = 70;

    // =======================================================
    // ====================== CORBA MOBS =====================
    // =======================================================

    public static final double LEAF_BLOWER_HEALTH = 65;
    public static final double LEAF_BLOWER_DAMAGE = 13;

    public static final double NATURE_MAGE_HEALTH = 60;
    ...
    public static final double DEPTHS_HUNTER_HEALTH = 58;
    public static final double DEPTHS_HUNTER_DAMAGE = 13;

    public static final double SPIKED_BEAST_HEALTH = 55;
    public static final double SPIKED_BEAST_DAMAGE = 11;

    // =======================================================
    // ======================= END MOBS ======================
    // =======================================================

    public static final double ENDER_CRAWLER_HEALTH = 40;
    public static final double ENDER_CRAWLER_DAMAGE = 7;

    public static final double ENDER_LEAPER_HEALTH = 40;
    public static final double ENDER_LEAPER_DAMAGE = 6;
    ...
    public static final double GOLDBOT_HEALTH = 30;
    ...
    public static final double INSECTO_HEALTH = 42;
    public static final double INSECTO_DAMAGE = 9;

    public static final double PSYOLLOM_HEALTH = 44;
    public static final double PSYOLLOM_DAMAGE = 10;

    public static final double SHIMMERER_HEALTH = 46;
    ...
    public static final double FROZEN_TROLL_HEALTH = 42;
    public static final double FROZEN_TROLL_DAMAGE = 10;
    public static final double FROZEN_TROLL_KNOCKBACK_RESISTANCE = 1;

    public static final double ICE_GOLEM_HEALTH = 250;
    public static final double ICE_GOLEM_DAMAGE = 20;
    public static final double ICE_GOLEM_KNOCKBACK_RESISTANCE = 3;

    public static final double PERMAFRAUST_HEALTH = 44;
    public static final double PERMAFRAUST_DAMAGE = 10;

    public static final double SHATTERER_HEALTH = 45;

    public static final double SHIVERING_BUSHWALKER_HEALTH = 42;
    public static final double SHIVERING_BUSHWALKER_DAMAGE = 9;
    ...
    public static final double HELLBOT_HEALTH = 30;
    public static final double HELLBOT_DAMAGE = 8;

    public static final double HELL_COW_HEALTH = 35;
    public static final double HELL_COW_DAMAGE = 7;
    public static final double HELL_COW_MOVEMENT_SPEED = 0.3;

    public static final double HELL_TURTLE_HEALTH = 40;
    public static final double HELL_TURTLE_DAMAGE = 7;
    public static final double HELL_TURTLE_KNOCKBACK_RESISTANCE = 1;

    public static final double INFERNO_BLAZE_HEALTH = 30;
    ...
    public static final double REAPER_HEALTH = 35;
    public static final double REAPER_DAMAGE = 7;
    public static final double REAPER_MOVEMENT_SPEED = 0.3;

    public static final double WITHERSPINE_HEALTH = 40;
    public static final double WITHERSPINE_DAMAGE = 8;

    // =======================================================
    // =================== OVERWORLD MOBS ====================
    // =======================================================

    public static final double BLIZZARD_HEALTH = 20;

    public static final double JUNGLE_GOLEM_HEALTH = 20;
    public static final double JUNGLE_GOLEM_DAMAGE = 4;
    public static final double JUNGLE_GOLEM_KNOCKBACK_RESISTANCE = 3;

    public static final double JUNGLE_SPIDER_HEALTH = 18;
    public static final double JUNGLE_SPIDER_DAMAGE = 4;

    public static final double JUNGLE_TURTLE_HEALTH = 30;
    public static final double JUNGLE_TURTLE_DAMAGE = 4;
    public static final double JUNGLE_TURTLE_KNOCKBACK_RESISTANCE = 1;

    public static final double BLUE_HONGLOW_HEALTH = 20;
    public static final double BLUE_HONGLOW_DAMAGE = 4;

    public static final double CAVELING_HEALTH = 25;
    public static final double CAVELING_DAMAGE = 4;

    public static final double NPC_HEALTH = 100;

    public static final double CAVE_MAGE_HEALTH = 30;

    public static final double CAVURN_HEALTH = 30;

    public static final double GREEN_HONGLOW_HEALTH = 20;
    public static final double GREEN_HONGLOW_DAMAGE = 4;

    public static final double HONGLOW_HEALTH = 20;
    public static final double HONGLOW_DAMAGE = 4;

    public static final double ROCKITE_SMASHER_HEALTH = 175;
    ...
    public static final double BOOM_HEALTH = 20;
    public static final double BOOM_MOVEMENT_SPEED = 0.200000011920929;

    public static final double DUNEWORM_HEALTH = 25;
    public static final double DUNEWORM_DAMAGE = 6;

    public static final double FIRE_MAGE_HEALTH = 25;

    public static final double FLORO_HEALTH = 25;

    public static final double ICE_MAGE_HEALTH = 25;

    public static final double MEDIUM_HONGO_HEALTH = 30;
    ...
    public static final double SMALL_HONGO_HEALTH = 20;
    public static final double SMALL_HONGO_DAMAGE = 3;

    public static final double SPECTRE_HEALTH = 25;
    public static final double SPECTRE_DAMAGE = 4;

    public static final double SPYCLOPS_HEALTH = 30;
    public static final double SPYCLOPS_DAMAGE = 3;

    public static final double SWAMP_FLY_HEALTH = 10;

    public static final double TURDUCKEN_HEALTH = 20;
    public static final double TURDUCKEN_DAMAGE = 5;

    public static final double WRAITH_HEALTH = 30;
    public static final double WRAITH_DAMAGE = 6;
