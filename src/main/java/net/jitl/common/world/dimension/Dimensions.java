...
public class Dimensions {
    ...
    public static final Identifier FROZEN_EFFECTS = JITL.rl("frozen");
    ...
    public static final Identifier EUCA_EFFECTS = JITL.rl("euca");
    ...
    public static final Identifier BOIL_EFFECTS = JITL.rl("boil");
    ...
    public static final Identifier DEPTHS_EFFECTS = JITL.rl("depths");
    ...
    public static final Identifier CORBA_EFFECTS = JITL.rl("corba");
    ...
    public static final Identifier TERRANIA_EFFECTS = JITL.rl("terrania");
    ...
    public static final Identifier CLOUDIA_EFFECTS = JITL.rl("cloudia");
