...
public class EucaRuinsFeature extends Feature<NoneFeatureConfiguration> {

	public EucaRuinsFeature(Codec<NoneFeatureConfiguration> codec) {
		super(codec);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		int maxHeight = 6;
		int maxColums = 9;
		BlockState spawn = JBlocks.EUCA_GOLD_GRASS.get().defaultBlockState();
