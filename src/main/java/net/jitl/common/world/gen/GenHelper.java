...
import net.jitl.core.helper.internal.MathUtils;
...
public class GenHelper {
    ...
    public static int getAverageFirstFreeHeight(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return getAverageFirstFreeHeight(chunkGenerator, x, z, x1, z1, Heightmap.Types.WORLD_SURFACE_WG, levelHeightAccessor, s);
    }

    public static int getAverageFirstFreeHeight(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, Heightmap.Types type, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return MathUtils.average(getBoxCornerFirstFreeHeights(chunkGenerator, x, z, x1, z1, type, levelHeightAccessor, s));
    }

    public static int getMinFirstFreeHeight(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return getMinFirstFreeHeight(chunkGenerator, x, z, x1, z1, Heightmap.Types.WORLD_SURFACE_WG, levelHeightAccessor, s);
    }

    public static int getMinFirstFreeHeight(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, Heightmap.Types type, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return MathUtils.min(getBoxCornerFirstFreeHeights(chunkGenerator, x, z, x1, z1, type, levelHeightAccessor, s));
    }

    public static int getMaxFirstFreeHeight(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return getMaxFirstFreeHeight(chunkGenerator, x, z, x1, z1, Heightmap.Types.WORLD_SURFACE_WG, levelHeightAccessor, s);
    }

    public static int getMaxFirstFreeHeight(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, Heightmap.Types type, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return MathUtils.max(getBoxCornerFirstFreeHeights(chunkGenerator, x, z, x1, z1, type, levelHeightAccessor, s));
    }

    private static int[] getBoxCornerFirstFreeHeights(ChunkGenerator chunkGenerator, int x, int z, int x1, int z1, Heightmap.Types type, LevelHeightAccessor levelHeightAccessor, RandomState s) {
        return new int[]{
                chunkGenerator.getFirstFreeHeight(x, z, type, levelHeightAccessor, s),
                chunkGenerator.getFirstFreeHeight(x1, z, type, levelHeightAccessor, s),
                chunkGenerator.getFirstFreeHeight(x, z1, type, levelHeightAccessor, s),
                chunkGenerator.getFirstFreeHeight(x1, z1, type, levelHeightAccessor, s)
        };
    }
