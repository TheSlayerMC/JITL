...
public class OverworldRuinsFeature extends Feature<NoneFeatureConfiguration> {

	public OverworldRuinsFeature(Codec<NoneFeatureConfiguration> codec) {
		super(codec);
	}
