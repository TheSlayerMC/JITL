package net.jitl.common.world.gen.frozen;
                ...
                for (int i1 = -l; i1 <= l; ++i1) {
                    ...
                    for (int j1 = -l; j1 <= l; ++j1) {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(rand.nextFloat() > 0.75F))) {
                            ...
                            if (blockstate.isAir() || block == JBlocks.FROSTY_ICE.get()) {
                                this.setBlock(reader, pos.offset(i1, k, j1), JBlocks.FROSTY_ICE.get().defaultBlockState());
                            }
            ...
            for (int l1 = -k1; l1 <= k1; ++l1) {
                for (int i2 = -k1; i2 <= k1; ++i2) {
                    ...
                    while (blockpos.getY() > 50) {
                        ...
                        if (!blockstate1.isAir() && block1 != JBlocks.FROSTY_ICE.get()) {
                            break;
                        }
                        this.setBlock(reader, blockpos, JBlocks.FROSTY_ICE.get().defaultBlockState());
