...
public class SulphurCrystalFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (reader.getBlockState(pos1.below()) != JBlocks.VOLCANIC_SAND.get().defaultBlockState()) {
            return false;
        } else {
                    ...
                    for (int j1 = -l; j1 <= l; ++j1) {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(rand.nextFloat() > 0.75F))) {
                            ...
                            if (blockstate.isAir() || block == JBlocks.SULPHUR_ROCK.get()) {
                                this.setBlock(reader, pos.offset(i1, k - 12, j1), JBlocks.SULPHUR_ROCK.get().defaultBlockState());
                            }
                        }
                    }
                }
