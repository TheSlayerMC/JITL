...
@Mod(JITL.MOD_ID)
public class JITL {
    public static final String MOD_ID = "jitl", MOD_VERSION = "2.2.7", MOD_NAME = "Journey Into the Light";
    ...
    public JITL(IEventBus modEventBus, ModContainer container) {
        ...
        if(DEV_MODE) {
            ...
            new JTorchBlockGenerator().generate();
            new JRedstoneLampBlockGenerator().generate();
            new JWallTorchBlockGenerator().generate();
