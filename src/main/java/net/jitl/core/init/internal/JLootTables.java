...
public class JLootTables {
    ...
    public static ResourceKey<LootTable> SHIVERING_RAM_WOOL = addLootTable("entities/shivering_ram_wool");
    ...
    public static ResourceKey<LootTable> addRuinTable(String name) {
        return ResourceKey.create(Registries.LOOT_TABLE, Identifier.parse(name));
    }
