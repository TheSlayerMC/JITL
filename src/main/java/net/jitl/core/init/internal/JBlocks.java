...
//    public static final DeferredBlock<Block> VERDITE_BLOCK = register("verdite_block", "Verdite Block", JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BOIL_COBBLESTONE_BUTTON = registerButton("boil_cobblestone_button", "Boiling Cobblestone Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> BOIL_COBBLESTONE_PRESSURE_PLATE = registerPressurePlate("boil_cobblestone_pressure_plate", "Boiling Cobblestone Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BOIL_BRICK_BUTTON = registerButton("boil_brick_button", "Boil Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> BOIL_BRICK_PRESSURE_PLATE = registerPressurePlate("boil_brick_pressure_plate", "Boil Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BOIL_SQUARE_BRICK_BUTTON = registerButton("boil_square_brick_button", "Boil Square Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> BOIL_SQUARE_BRICK_PRESSURE_PLATE = registerPressurePlate("boil_square_brick_pressure_plate", "Boil Square Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BOIL_SHINGLE_BUTTON = registerButton("boil_shingle_button", "Boil Shingle Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> BOIL_SHINGLE_PRESSURE_PLATE = registerPressurePlate("boil_shingle_pressure_plate", "Boil Shingle Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BLAZIER_BRICK_BUTTON = registerButton("blazier_brick_button", "Blazier Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> BLAZIER_BRICK_PRESSURE_PLATE = registerPressurePlate("blazier_brick_pressure_plate", "Blazier Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BLAZIER_METAL_BUTTON = registerButton("blazier_metal_button", "Blazier Metal Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> BLAZIER_METAL_PRESSURE_PLATE = registerPressurePlate("blazier_metal_pressure_plate", "Blazier Metal Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> SCORCHED_RUBBLE_BRICK_BUTTON = registerButton("scorched_rubble_brick_button", "Scorched Rubble Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> SCORCHED_RUBBLE_BRICK_PRESSURE_PLATE = registerPressurePlate("scorched_rubble_brick_pressure_plate", "Scorched Rubble Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> GOLDITE_COBBLESTONE_BUTTON = registerButton("goldite_cobblestone_button", "Goldite Cobblestone Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> GOLDITE_COBBLESTONE_PRESSURE_PLATE = registerPressurePlate("goldite_cobblestone_pressure_plate", "Goldite Cobblestone Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> EUCA_GOLD_BUTTON = registerButton("euca_gold_button", "Euca Gold Button", false, true, JBlockProperties.WOOD);
    public static final DeferredBlock<JPressurePlateBlock> EUCA_GOLD_PRESSURE_PLATE = registerPressurePlate("euca_gold_pressure_plate", "Euca Gold Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> EUCA_BROWN_BUTTON = registerButton("euca_brown_button", "Euca Brown Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> EUCA_BROWN_PRESSURE_PLATE = registerPressurePlate("euca_brown_pressure_plate", "Euca Brown Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> PERMAFROST_BUTTON = registerButton("permafrost_button", "Permafrost Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> PERMAFROST_PRESSURE_PLATE = registerPressurePlate("permafrost_pressure_plate", "Permafrost Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> FROZEN_BUTTON = registerButton("frozen_button", "Frostwood Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> FROZEN_PRESSURE_PLATE = registerPressurePlate("frozen_pressure_plate", "Frostwood Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> PACKED_SNOW_BRICK_BUTTON = registerButton("packed_snow_brick_button", "Packed Snow Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> PACKED_SNOW_BRICK_PRESSURE_PLATE = registerPressurePlate("packed_snow_brick_pressure_plate", "Packed Snow Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> PACKED_ICE_BRICK_BUTTON = registerButton("packed_ice_brick_button", "Packed Ice Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> PACKED_ICE_BRICK_PRESSURE_PLATE = registerPressurePlate("packed_ice_brick_pressure_plate", "Packed Ice Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> FROZEN_BRICK_BUTTON = registerButton("frozen_brick_button", "Frozen Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> FROZEN_BRICK_PRESSURE_PLATE = registerPressurePlate("frozen_brick_pressure_plate", "Frozen Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> VOLCANIC_SANDSTONE_BUTTON = registerButton("volcanic_sandstone_button", "Volcanic Sandstone Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> VOLCANIC_SANDSTONE_PRESSURE_PLATE = registerPressurePlate("volcanic_sandstone_pressure_plate", "Volcanic Sandstone Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> BURNED_BUTTON = registerButton("burned_button", "Burned Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> BURNED_PRESSURE_PLATE = registerPressurePlate("burned_pressure_plate", "Burned Pressure Plate",true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> DEPTHS_BUTTON = registerButton("depths_button", "Depths Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> DEPTHS_PRESSURE_PLATE = registerPressurePlate("depths_pressure_plate", "Depths Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> DARK_BRICK_BUTTON = registerButton("dark_brick_button", "Dark Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DARK_BRICK_PRESSURE_PLATE = registerPressurePlate("dark_brick_pressure_plate", "Dark Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DARK_FLOOR_BUTTON = registerButton("dark_floor_button", "Dark Floor Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DARK_FLOOR_PRESSURE_PLATE = registerPressurePlate("dark_floor_pressure_plate", "Dark Floor Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DARK_SHINGLE_BUTTON = registerButton("dark_shingle_button", "Dark Shingle Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DARK_SHINGLE_PRESSURE_PLATE = registerPressurePlate("dark_shingle_pressure_plate", "Dark Shingle Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DEPTHS_BRICK_BUTTON = registerButton("depths_brick_button", "Depths Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DEPTHS_BRICK_PRESSURE_PLATE = registerPressurePlate("depths_brick_pressure_plate", "Depths Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DEPTHS_SHINGLE_BUTTON = registerButton("depths_shingle_button", "Depths Shingle Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DEPTHS_SHINGLE_PRESSURE_PLATE = registerPressurePlate("depths_shingle_pressure_plate", "Depths Shingle Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DEPTHS_DARK_SHINGLE_BUTTON = registerButton("depths_dark_shingle_button", "Depths Dark Shingle Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DEPTHS_DARK_SHINGLE_PRESSURE_PLATE = registerPressurePlate("depths_dark_shingle_pressure_plate", "Depths Dark Shingle Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DEPTHS_COBBLESTONE_BUTTON = registerButton("depths_cobblestone_button", "Depths Cobblestone Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DEPTHS_COBBLESTONE_PRESSURE_PLATE = registerPressurePlate("depths_cobblestone_pressure_plate", "Depths Cobblestone Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> DEPTHS_TILE_BUTTON = registerButton("depths_tile_button", "Depths Tile Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> DEPTHS_TILE_PRESSURE_PLATE = registerPressurePlate("depths_tile_pressure_plate", "Depths Tile Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_BUTTON = registerButton("corba_button", "Corba Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_PRESSURE_PLATE = registerPressurePlate("corba_pressure_plate", "Corba Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_COBBLESTONE_BUTTON = registerButton("corba_cobblestone_button", "Corba Cobblestone Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_COBBLESTONE_PRESSURE_PLATE = registerPressurePlate("corba_cobblestone_pressure_plate", "Corba Cobblestone Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_BRICK_BUTTON = registerButton("corba_brick_button", "Corba Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_BRICK_PRESSURE_PLATE = registerPressurePlate("corba_brick_pressure_plate", "Corba Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_CRACKED_BRICK_BUTTON = registerButton("corba_cracked_brick_button", "Corba Cracked Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_CRACKED_BRICK_PRESSURE_PLATE = registerPressurePlate("corba_cracked_brick_pressure_plate", "Corba Cracked Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_DARK_BRICK_BUTTON = registerButton("corba_dark_brick_button", "Corba Dark Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_DARK_BRICK_PRESSURE_PLATE = registerPressurePlate("corba_dark_brick_pressure_plate", "Corba Dark Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_LIGHT_BRICK_BUTTON = registerButton("corba_light_brick_button", "Corba Light Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_LIGHT_BRICK_PRESSURE_PLATE = registerPressurePlate("corba_light_brick_pressure_plate", "Corba Light Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CORBA_SENTRY_BRICK_BUTTON = registerButton("corba_sentry_brick_button", "Corba Sentry Brick Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> CORBA_SENTRY_BRICK_PRESSURE_PLATE = registerPressurePlate("corba_sentry_brick_pressure_plate", "Corba Sentry Brick Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<Block> ELDER_BLOCK = register("elder_block", "Elder Block", ChangableBlock::new, JBlockProperties.STONE_METAL);
    ...
    public static final DeferredBlock<JButtonBlock> TERRANIAN_STONE_BUTTON = registerButton("terranian_stone_button", "Terranian Stone Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> TERRANIAN_STONE_PRESSURE_PLATE = registerPressurePlate("terranian_stone_pressure_plate", "Terranian Stone Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> TERRANIAN_BUTTON = registerButton("terranian_button", "Terranian Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> TERRANIAN_PRESSURE_PLATE = registerPressurePlate("terranian_pressure_plate", "Terranian Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<JButtonBlock> TERRANIAN_DARK_PANEL_BUTTON = registerButton("terranian_dark_panel_button", "Terranian Dark Panel Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> TERRANIAN_DARK_PANEL_PRESSURE_PLATE = registerPressurePlate("terranian_dark_panel_pressure_plate", "Terranian Dark Panel Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> TERRANIAN_PANEL_BUTTON = registerButton("terranian_panel_button", "Terranian Panel Button", false, false, JBlockProperties.STONE);
    public static final DeferredBlock<JPressurePlateBlock> TERRANIAN_PANEL_PRESSURE_PLATE = registerPressurePlate("terranian_panel_pressure_plate", "Terranian Panel Plate", false, JBlockProperties.STONE);
    ...
    public static final DeferredBlock<JButtonBlock> CLOUDIA_BUTTON = registerButton("cloudia_button", "Cloudia Button", true, true, JBlockProperties.BUTTON);
    public static final DeferredBlock<JPressurePlateBlock> CLOUDIA_PRESSURE_PLATE = registerPressurePlate("cloudia_pressure_plate", "Cloudia Pressure Plate", true, JBlockProperties.WOOD);
    ...
    public static final DeferredBlock<BushBlock> REDCURRANT_BUSH = registerGrowingBushBlock("redcurrant_bush", "Redcurrant Bush", RedcurrantBushBlock::new);
    public static final DeferredBlock<BushBlock> BRADBERRY_BUSH = registerGrowingBushBlock("bradberry_bush", "Bradberry Bush", BradberryBushBlock::new);
    ...
    public static DeferredBlock<BushBlock> registerGrowingBushBlock(String name, String translatedName, Function<BlockBehaviour.Properties, ? extends BushBlock> block) {
        bushBlockName.add(name);
        bushLangName.add(translatedName);
        DeferredBlock<BushBlock> block1 = BLOCKS.registerBlock(name, block, p -> JBlockProperties.GROWING_BUSH);
        JItems.registerBlockItem(name, () -> new BlockItem(block1.get(), JItems.itemProps(name).useBlockDescriptionPrefix()));
        return block1;
    }
    ...
    public static DeferredBlock<JButtonBlock> registerButton(String name, String translatedName, boolean sensitive, boolean wood, BlockBehaviour.Properties p) {
        if(wood) {
            addAxeableBlocks(name);
        } else {
            addPickaxeableBlocks(name);
        ...
        DeferredBlock<JButtonBlock> block1 = BLOCKS.register(name, () -> new JButtonBlock(BlockSetType.OAK, sensitive ? 20 : 30, p.setId(ResourceKey.create(Registries.BLOCK, JITL.rl(name)))) {
            @Override
    ...
    public static DeferredBlock<JPressurePlateBlock> registerPressurePlate(String name, String translatedName, boolean wood, BlockBehaviour.Properties p) {
        if(wood) {
            addAxeableBlocks(name);
        } else {
            addPickaxeableBlocks(name);
        ...
        DeferredBlock<JPressurePlateBlock> block1 = BLOCKS.register(name, () -> new JPressurePlateBlock(BlockSetType.OAK, p.setId(ResourceKey.create(Registries.BLOCK, JITL.rl(name)))));
        JItems.registerBlockItem(name, () -> new BlockItem(block1.get(), JItems.itemProps(name).useBlockDescriptionPrefix()) {
            @Override
            public int getBurnTime(@NotNull ItemStack itemStack, @Nullable RecipeType<?> recipeType, @NotNull FuelValues fuelValues) {
                return wood ? 300 : 0;
    ...
    public static DeferredBlock<FenceGateBlock> registerFenceGate(String name, String translatedName, boolean wood, BlockBehaviour.Properties p) {
        ...
        DeferredBlock<FenceGateBlock> block1 = BLOCKS.register(name, () -> new FenceGateBlock(Optional.of(WoodType.OAK), p.setId(ResourceKey.create(Registries.BLOCK, JITL.rl(name))), Optional.of(WoodType.OAK.fenceGateOpen()), Optional.of(WoodType.OAK.fenceGateClose())));
        JItems.registerBlockItem(name, () -> new BlockItem(block1.get(), JItems.itemProps(name).useBlockDescriptionPrefix()) {
            @Override
            public int getBurnTime(@NotNull ItemStack itemStack, @Nullable RecipeType<?> recipeType, @NotNull FuelValues fuelValues) {
                return wood ? 300 : 0;
