...
public class JItems {
    ...
    public static final DeferredItem<Item> REDCURRANT_BERRY = registerNormalItem("redcurrant_berry", "Redcurrant Berry", (p) -> new BlockItem(JBlocks.REDCURRANT_BUSH.get(), p.food(JFood.REDCURRANT)));
    public static final DeferredItem<Item> BRADBERRY = registerNormalItem("bradberry", "bradberry", (p) -> new BlockItem(JBlocks.BRADBERRY_BUSH.get(), p.food(JFood.BRADBERRY)));
    ...
    public static final DeferredItem<Item> STAFF_OF_CONJURING = registerToolItem("staff_of_conjuring", "Staff of Conjuring", (p) -> new StaffItem(p, 1, 5, 256, ConjuringProjectileEntity::new));
    public static final DeferredItem<Item> STAFF_OF_ESSENCIA = registerToolItem("staff_of_essencia", "Staff of Essencia", (p) -> new StaffItem(p, 4, 6, 256, EssenciaProjectileEntity::new));
    public static final DeferredItem<Item> STAFF_OF_HELLSTONE = registerToolItem("staff_of_hellstone", "Staff Of Hellstone", (p) -> new StaffItem(p, 4, 7, 256, HellstoneEntity::new));
    public static final DeferredItem<Item> WIZARDS_STAR = registerToolItem("wizards_star", "Wizard's Star", (p) -> new StaffItem(p, 4, 5, 256, WizardsStarEntity::new));
    public static final DeferredItem<Item> DOOMSBRINGER = registerToolItem("doomsbringer", "Doomsbringer", (p) -> new StaffItem(p, 4, 12, 256, DoomsbringerEntity::new));
    public static final DeferredItem<Item> OVERGROWN_STAFF = registerToolItem("overgrown_staff", "Overgrown Staff", (p) -> new StaffItem(p, 4, 5, 256, OvergrownEntity::new));
    public static final DeferredItem<Item> STAFF_OF_DIVINITY = registerToolItem("staff_of_divinity", "Staff of Divinity", (p) -> new StaffItem(p, 4, 9, 256, DivinityEntity::new));
    public static final DeferredItem<Item> STAFF_OF_ENLIGHTENMENT = registerToolItem("staff_of_enlightenment", "Staff of Enlightenment", (p) -> new StaffItem(p, 4, 14, 256, EnlightenmentEntity::new));
    public static final DeferredItem<Item> CRYSTAL_STAFF = registerToolItem("crystal_staff", "Crystal Staff", (p) -> new StaffItem(p, 4, 10, 256, IceballEntity::new));
    public static final DeferredItem<Item> STAFF_OF_GREENPACE = registerToolItem("staff_of_greenpace", "Staff of Greenpace", (p) -> new StaffItem(p ,4, 10, 256, GreenpaceEntity::new));
    public static final DeferredItem<Item> TELEPORTATION_STAFF = registerToolItem("teleportation_staff", "Teleportation Staff", (p) -> new TeleportItem(p,4, 256));

    public static final DeferredItem<Item> GUN_BASE = registerNormalItem("gun_base", "Gun Base");
    public static final DeferredItem<Item> NETHER_PLASMA = register("nether_plasma", "Nether Plasma", (p) -> new GunItem(p, 4, 6, 512, NetherPlasmaEntity::new), ItemType.GUN);
    public static final DeferredItem<Item> OCEAN_PLASMA = register("ocean_plasma", "Ocean Plasma", (p) -> new GunItem(p, 4, 4, 512, OceanPlasmaEntity::new), ItemType.GUN);
    public static final DeferredItem<Item> FOREST_PLASMA = register("forest_plasma", "Forest Plasma", (p) -> new GunItem(p, 4, 4, 512, BouncingOvergrownEntity::new), ItemType.GUN);
    public static final DeferredItem<Item> ROCK_LAUNCHER = register("rock_launcher", "Rock Launcher", (p) -> new GunItem(p, 4, 4, 512, BouncingDivinityEntity::new), ItemType.GUN);
    public static final DeferredItem<Item> CHAOS_CANNON = register("chaos_cannon", "Chaos Cannon", (p) -> new GunItem(p, 4, 6, 512, ChaosCannonEntity::new), ItemType.GUN);
    public static final DeferredItem<Item> EYE_BLASTER = register("eye_blaster", "Eye Blaster", (p) -> new GunItem(p, 4, 12, 512, EyeBlasterEntity::new), ItemType.GUN);

    public static final DeferredItem<Item> SPELLBINDING_HAMMER = register("spellbinding_hammer", "Spellbinding Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, SpellbindingEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> EARTHEN_HAMMER = register("earthen_hammer", "Earthen Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, EarthenEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> FLAMING_HAMMER = register("flaming_hammer", "Flaming Hammer", (p) -> new HammerItem(p ,JToolTiers.HAMMER, 4, 12, FlamingHammerEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> NETHIC_HAMMER = register("nethic_hammer", "Nethic Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, NethicEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> OVERGROWN_HAMMER = register("overgrown_hammer", "Overgrown Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, OvergrownHammerEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> ROCKY_HAMMER = register("rocky_hammer", "Rocky Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, RockyHammerEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> ROYAL_HAMMER = register("royal_hammer", "Royal Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, RoyalEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> CRYSTALLIZED_HAMMER = register("crystallized_hammer", "Crystallized Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, CrystallizedEntity::new), ItemType.HAMMER);
    public static final DeferredItem<Item> WITHIC_HAMMER = register("withic_hammer", "Withic Hammer", (p) -> new HammerItem(p, JToolTiers.HAMMER, 4, 12, WithicEntity::new), ItemType.HAMMER);

    public static final DeferredItem<Item> ROCKY_BATTLE_AXE = registerToolItem("rocky_battle_axe", "Rocky Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -2), ItemType.AXE);
    public static final DeferredItem<Item> CRYSTALLIZED_BATTLE_AXE = registerToolItem("crystallized_battle_axe", "Crystallized Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -3), ItemType.AXE);
    public static final DeferredItem<Item> BACK_BITER = registerToolItem("back_biter", "Back Biter", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -3), ItemType.AXE);
    public static final DeferredItem<Item> DAWN_BREAKER = registerToolItem("dawn_breaker", "Dawn Breaker", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -2), ItemType.AXE);
    public static final DeferredItem<Item> TEMPEST_BATTLE_AXE = registerToolItem("tempest_battle_axe", "Tempest Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -3), ItemType.AXE);
    public static final DeferredItem<Item> BRONZED_BATTLE_AXE = registerToolItem("bronzed_battle_axe", "Bronzed Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -3), ItemType.AXE);
    public static final DeferredItem<Item> CELESTITE_BATTLE_AXE = registerToolItem("celestite_battle_axe", "Celestite Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -2), ItemType.AXE);
    public static final DeferredItem<Item> STORUM_BATTLE_AXE = registerToolItem("storum_battle_axe", "Storum Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -2), ItemType.AXE);
    public static final DeferredItem<Item> CELEKIUM_BATTLE_AXE = registerToolItem("celekium_battle_axe", "Celekium Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, -2), ItemType.AXE);
    public static final DeferredItem<Item> THUNDERBIRD_BATTLE_AXE = registerToolItem("thunderbird_battle_axe", "Thunderbird Battle Axe", (p) -> new BattleAxeItem(p, JToolTiers.BATTLE_AXE, 0), ItemType.AXE);
    ...
    public static final DeferredItem<Item> DEMONIC_BOMB = registerNormalItem("demonic_bomb", "Demonic Bomb",
            (p) -> new DemonicBombItem(p).setSound(() -> SoundEvents.SNOWBALL_THROW));
    ...
    public static final DeferredItem<Item> RING_OF_HARMING = registerNormalItem("ring_of_harming", "Ring of Harming", (p) -> new JRingItem(p.stacksTo(1)).effect(MobEffects.INSTANT_DAMAGE));
    public static final DeferredItem<Item> RING_OF_MINING_FATIGUE = registerNormalItem("ring_of_mining_fatigue", "Ring of Mining Fatigue", (p) -> new JRingItem(p.stacksTo(1)).effect(MobEffects.MINING_FATIGUE));
    public static final DeferredItem<Item> RING_OF_NAUSEA = registerNormalItem("ring_of_nausea", "Ring of Nausea", (p) -> new JRingItem(p.stacksTo(1)).effect(MobEffects.NAUSEA));
    public static final DeferredItem<Item> RING_OF_SLOWNESS = registerNormalItem("ring_of_slowness", "Ring of Slowness", (p) -> new JRingItem(p.stacksTo(1)).effect(MobEffects.SLOWNESS));
    ...
    public static final DeferredItem<Item> CLOUDWALKER_AMULET = registerNormalItem("cloudwalker_amulet", "Cloudwalker Amulet", CloudWalkerAmuletItem::new);
