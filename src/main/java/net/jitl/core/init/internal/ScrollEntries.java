...
public class ScrollEntries {
    ...
    public static final ScrollEntry MY_LAST_WORDS = new ScrollEntryBuilder("my_last_words", "My Last Words", "They're Coming...",  10, 10)
            .addTextComponent("scroll.jitl.chap1.my_last_words")
            .build();

    public static final ScrollEntry NETHERIC_STATUS = new ScrollEntryBuilder("netheric_status", "Netheric Status", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.netheric_status")
            .build();

    public static final ScrollEntry THE_END = new ScrollEntryBuilder("the_end", "The End", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.the_end")
            .build();

    public static final ScrollEntry BEYOND_BOILING = new ScrollEntryBuilder("beyond_boiling", "Beyond Boiling", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.beyond_boiling")
            .build();

    public static final ScrollEntry THE_ROYALS = new ScrollEntryBuilder("the_royals", "The Royals", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.the_royals")
            .build();

    public static final ScrollEntry DARKNESS = new ScrollEntryBuilder("darkness", "Darkness", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.darkness")
            .build();

    public static final ScrollEntry FROZEN_DESPAIR = new ScrollEntryBuilder("frozen_despair", "Frozen Despair", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.frozen_despair")
            .build();

    public static final ScrollEntry SENTERIAN_GOSPEL = new ScrollEntryBuilder("senterian_gospel", "Senterian Gospel", "Book of Divinity", 10, 10)
            .addTextComponent("scroll.jitl.sentry_gospel")
            .build();

    public static final ScrollEntry FUNGI = new ScrollEntryBuilder("fungi", "Fungi Everywhere", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.fungi")
            .build();

    public static final ScrollEntry MIST = new ScrollEntryBuilder("mist", "Mist In The Distance", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.mist")
            .build();

    public static final ScrollEntry THIS_IS_IT = new ScrollEntryBuilder("this_is_it", "This Is It", "1",  10, 10)
            .addTextComponent("scroll.jitl.chap1.this_is_it")
            .build();

    public static final ScrollEntry TEST = new ScrollEntryBuilder("test", "test", "Testing. test. this is a test.",  10, 10)
