...
public enum JToolTiers {
    ...
    public static class JToolTier {
        ...
        public static final Tier HAMMER = new SimpleTier(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 642, 8F, 6F, 25, () -> Ingredient.EMPTY);
        ...
        public static final Tier BATTLE_AXE = new SimpleTier(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 768, 12F, 7F, 15, () -> Ingredient.EMPTY);
    }
