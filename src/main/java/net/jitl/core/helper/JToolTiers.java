...
public enum JToolTiers implements Tier {
    SAPPHIRE(1461, 10F, 8F, 5F, 3F, 1.6F, JItems.SAPPHIRE.get()),
    SHADIUM(1461, 10F, 8F, 5F, 3F, 1.6F, JItems.SHADIUM_INGOT.get()),
    LUNIUM(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.LUNIUM_INGOT.get()),
    BLOODCRUST(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.BLOODCRUST_INGOT.get()),
    CELESTIUM(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.CELESTIUM_GEMSTONE.get()),
    KORITE(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.KORITE_GEMSTONE.get()),
    MEKYUM(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.MEKYUM_GEMSTONE.get()),
    STORON(1490, 12F, 8F, 6F, 4F, 1.7F, JItems.STORON_GEMSTONE.get()),

    CREATIVE(1490, 12F, 1000F, 1000F, 1000F, 2.7F, JItems.STORON_GEMSTONE.get());
