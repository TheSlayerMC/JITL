...
public class JEntityLootTables extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(JEntities.HELL_TURTLE_TYPE.get(), empty());
        this.add(JEntities.REAPER_TYPE.get(), empty());
        this.add(JEntities.INFERNO_BLAZE_TYPE.get(), empty());
        this.add(JEntities.HELL_COW_TYPE.get(), empty());
        this.add(JEntities.SPYCLOPSE_TYPE.get(), empty());
        this.add(JEntities.DARKENER_TYPE.get(), empty());
        ...
        this.add(JEntities.BLIZZARD_TYPE.get(), empty());
        this.add(JEntities.BIG_HONGO_TYPE.get(), empty());
        this.add(JEntities.MEDIUM_HONGO_TYPE.get(), empty());
        this.add(JEntities.SMALL_HONGO_TYPE.get(), empty());
        this.add(JEntities.JUNGLE_TURTLE_TYPE.get(), empty());
        this.add(JEntities.JUNGLE_GOLEM_TYPE.get(), empty());
        this.add(JEntities.SAND_CRAWLER_TYPE.get(), empty());
        this.add(JEntities.ROCKITE_GOLEM_TYPE.get(), empty());
        this.add(JEntities.CAVELING_TYPE.get(), empty());
        this.add(JEntities.CAVURN_TYPE.get(), empty());
        this.add(JEntities.STONEWALKER_TYPE.get(), empty());
