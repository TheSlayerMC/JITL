...
public class JBlockGenerator {
    ...
    public void generate() {
        for (String name : JBlocks.blockName) {
            ...
            getNormalBlockItem(JITL.MODID, name);
            getNormalBlockModel(JITL.MODID, name);
            getNormalBlockstate(JITL.MODID, name);

            writerInit();
        }
    }

    public void getNormalBlockItem(String modID, String name) {
        writeToItemModelFile("{");
        writeToItemModelFile("  \"parent\": \"" + modID + ":block/" + name + "\"");
        writeToItemModelFile("}");
    }

    public void getNormalBlockModel(String modID, String name) {
    ...
    public void getNormalBlockstate(String modID, String name) {
