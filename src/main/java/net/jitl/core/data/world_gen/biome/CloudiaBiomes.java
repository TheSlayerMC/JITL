...
public class CloudiaBiomes extends Biomes {
    ...
    public static Biome cloudia(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        mobSettings.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(JEntities.CLOUD_GHOST_TYPE.get(), 1, 3));
        mobSettings.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(JEntities.SKY_EEL_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(JEntities.STARLIGHT_GOLEM_TYPE.get(),1, 3));
        mobSettings.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(JEntities.STARLIGHT_TRANSPORTER_TYPE.get(),1, 3));
        mobSettings.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(JEntities.STARLIGHT_WALKER_TYPE.get(),1, 3));

        mobSettings.addSpawn(MobCategory.CREATURE, 15, new MobSpawnSettings.SpawnerData(JEntities.AERO_LOTUS_TYPE.get(), 1, 1));
