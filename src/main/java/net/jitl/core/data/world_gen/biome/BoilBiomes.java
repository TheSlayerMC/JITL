...
public class BoilBiomes extends Biomes {
    ...
    public static Biome boil(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        //biomeSetting.addCarver(worldCarvers.getOrThrow(CarverFeatureKeys.BOIL_CARVER));
        ...
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(JEntities.MAGMA_BLAZE_TYPE.get(), 1, 3));
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(JEntities.FRIGHTENER_TYPE.get(), 1, 3));
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(JEntities.BURNING_LIGHT_TYPE.get(), 1, 3));
        mobSettings.addSpawn(MobCategory.CREATURE, 15, new MobSpawnSettings.SpawnerData(JEntities.FLAME_LOTUS_TYPE.get(), 1, 3));
    ...
    public static Biome scorchedWastelands(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        BiomeGenerationSettings.Builder biomeSetting = new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers);
        MobSpawnSettings.Builder mobSettings = new MobSpawnSettings.Builder();
        //.addCarver(worldCarvers.getOrThrow(CarverFeatureKeys.BOIL_CARVER));
    ...
    public static Biome boilingSands(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        BiomeGenerationSettings.Builder biomeSetting = new BiomeGenerationSettings.Builder(placedFeatures, worldCarvers);
        MobSpawnSettings.Builder mobSettings = new MobSpawnSettings.Builder();
        //biomeSetting.addCarver(CarverFeatureKeys.BOIL_CARVER);
