...
public class CorbaBiomes extends Biomes {
    ...
    public static Biome bogweedFields(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        mobSettings.addSpawn(MobCategory.MONSTER, 4, new MobSpawnSettings.SpawnerData(JEntities.WOOD_CREATURE_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(JEntities.SMELLY_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(EntityTypes.DROWNED, 1, 1));

        mobSettings.addSpawn(MobCategory.CREATURE, 20, new MobSpawnSettings.SpawnerData(JEntities.CORBANIAN_MOLLUSK_TYPE.get(), 1, 2));
        mobSettings.addSpawn(MobCategory.WATER_AMBIENT, 10, new MobSpawnSettings.SpawnerData(EntityTypes.COD, 3, 6));
        mobSettings.addSpawn(MobCategory.WATER_AMBIENT, 5, new MobSpawnSettings.SpawnerData(EntityTypes.SALMON, 1, 5));
        mobSettings.addSpawn(MobCategory.WATER_CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityTypes.SQUID, 1, 4));
    ...
    public static Biome taintedSwamp(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        mobSettings.addSpawn(MobCategory.MONSTER, 4, new MobSpawnSettings.SpawnerData(JEntities.WOOD_CREATURE_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(JEntities.SMELLY_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 4, new MobSpawnSettings.SpawnerData(JEntities.STINKY_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 2, new MobSpawnSettings.SpawnerData(EntityTypes.DROWNED, 1, 1));

        mobSettings.addSpawn(MobCategory.CREATURE, 20, new MobSpawnSettings.SpawnerData(JEntities.CORBANIAN_MOLLUSK_TYPE.get(), 1, 2));
        mobSettings.addSpawn(MobCategory.CREATURE, 40, new MobSpawnSettings.SpawnerData(JEntities.SWAMP_FLY_TYPE.get(), 1, 3));
        mobSettings.addSpawn(MobCategory.WATER_AMBIENT, 10, new MobSpawnSettings.SpawnerData(EntityTypes.COD, 3, 6));
        mobSettings.addSpawn(MobCategory.WATER_AMBIENT, 5, new MobSpawnSettings.SpawnerData(EntityTypes.SALMON, 1, 5));
        mobSettings.addSpawn(MobCategory.WATER_CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityTypes.SQUID, 1, 4));
