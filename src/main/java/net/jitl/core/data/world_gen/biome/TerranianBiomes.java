...
public class TerranianBiomes extends Biomes {
    ...
    public static Biome terrania(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.ARANA_KING_TYPE.get(), 1, 2));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.PURPLIAN_TYPE.get(), 1, 2));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRAGROW_TYPE.get(), 1, 2));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRASCATTERER_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRASLUG_TYPE.get(), 1, 1));
    ...
    public static Biome mushroomForest(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRAGROW_TYPE.get(),1, 2));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRASCATTERER_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRASHROOM_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(JEntities.TERRASLUG_TYPE.get(), 1, 1));
        mobSettings.addSpawn(MobCategory.MONSTER, 3, new MobSpawnSettings.SpawnerData(JEntities.FLUNGAS_TYPE.get(), 1, 1));
