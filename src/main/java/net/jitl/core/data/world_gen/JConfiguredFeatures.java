...
public class JConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, SHADIUM_ORE, Feature.ORE, new OreConfiguration(Suppliers.memoize(() -> List.of(OreConfiguration.target(OVERWORLD_REPLACEABLES, JBlocks.SHADIUM_ORE.get().defaultBlockState()), OreConfiguration.target(OVERWORLD_DEEPSLATE_REPLACEABLES, JBlocks.DEEPSLATE_SAPPHIRE_ORE.get().defaultBlockState()))).get(), 7));
        register(context, LUNIUM_ORE, Feature.ORE, new OreConfiguration(Suppliers.memoize(() -> List.of(OreConfiguration.target(OVERWORLD_REPLACEABLES, JBlocks.LUNIUM_ORE.get().defaultBlockState()), OreConfiguration.target(OVERWORLD_DEEPSLATE_REPLACEABLES, JBlocks.DEEPSLATE_SAPPHIRE_ORE.get().defaultBlockState()))).get(), 7));
        ...
        register(context, BLAZIUM_ORE, Feature.ORE, new OreConfiguration(Suppliers.memoize(() -> List.of(OreConfiguration.target(NETHER_ORE_REPLACEABLES, JBlocks.BLAZIUM_ORE.get().defaultBlockState()))).get(), 7));
        register(context, ASHUAL_ORE, Feature.ORE, new OreConfiguration(Suppliers.memoize(() -> List.of(OreConfiguration.target(NETHER_ORE_REPLACEABLES, JBlocks.ASHUAL_ORE.get().defaultBlockState()))).get(), 7));
