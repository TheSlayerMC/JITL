...
public class JConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, GLOWSHROOMS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.GREEN_GLOWSHROOM.get().defaultBlockState(), 1).add(JBlocks.TALL_GREEN_GLOWSHROOM.get().defaultBlockState(), 1).add(JBlocks.BLUE_GLOWSHROOM.get().defaultBlockState(), 1).add(JBlocks.TALL_BLUE_GLOWSHROOM.get().defaultBlockState(), 1).add(JBlocks.RED_GLOWSHROOM.get().defaultBlockState(), 1).add(JBlocks.TALL_RED_GLOWSHROOM.get().defaultBlockState(), 1))));
        ...
        //EUCA
        register(context, EUCA_GOLD_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.EUCA_GOLD_LOG.get()), new ForkingTrunkPlacer(4, 1, 6), BlockStateProvider.simple(JBlocks.EUCA_GOLD_LEAVES.get()), new SphericalFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), 1), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.GOLDITE_DIRT.get())).build());
        register(context, EUCA_GREEN_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.EUCA_BROWN_LOG.get()), new ForkingTrunkPlacer(4, 1, 6), BlockStateProvider.simple(JBlocks.EUCA_GREEN_LEAVES.get()), new SphericalFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), 1), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.GOLDITE_DIRT.get())).build());
        ...
        register(context, EUCA_GOLDITE_RUINS, JFeatures.RUINS.get(), new RuinsFeatureConfig(EUCA_GRASS, BlockStateProvider.simple(JBlocks.EUCA_CHEST.get()), new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.EUCA_SQUARE_BRICKS.get().defaultBlockState(), 3).add(JBlocks.EUCA_SQUARE_RUNIC_BRICKS.get().defaultBlockState(), 1).add(JBlocks.EUCA_RUNIC_BRICKS.get().defaultBlockState(), 2)), 8, 6, 9, BuiltInLootTables.VILLAGE_WEAPONSMITH.identifier()));
        register(context, EUCA_RUINS, JFeatures.RUINS.get(), new RuinsFeatureConfig(EUCA_GRASS, BlockStateProvider.simple(JBlocks.EUCA_CHEST.get()), new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.EUCA_SQUARE_BRICKS.get().defaultBlockState(), 3).add(JBlocks.EUCA_SQUARE_RUNIC_BRICKS.get().defaultBlockState(), 1).add(JBlocks.EUCA_RUNIC_BRICKS.get().defaultBlockState(), 2)), 7, 6, 9, BuiltInLootTables.VILLAGE_WEAPONSMITH.identifier()));
        ...
        register(context, GOLDITE_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.GOLDITE_TALL_GRASS.get().defaultBlockState(), 1).add(JBlocks.GOLDITE_STALKS.get().defaultBlockState(), 1).add(JBlocks.GOLDITE_FLOWER.get().defaultBlockState(), 1).add(JBlocks.GOLDITE_BULB.get().defaultBlockState(), 1))));
        register(context, GOLD_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.EUCA_SILVER_FLOWER.get().defaultBlockState(), 1).add(JBlocks.EUCA_TALL_FLOWERS.get().defaultBlockState(), 1).add(JBlocks.EUCA_TALL_GRASS.get().defaultBlockState(), 1).add(JBlocks.GOLDITE_BULB.get().defaultBlockState(), 1))));
        ...
        register(context, EUCA_PUMPKIN, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(JBlocks.EUCA_PUMPKIN.get())));
        ...
        register(context, DEPTHS_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.DEPTHS_BLUE_FLOWER.get().defaultBlockState(), 1).add(JBlocks.DEPTHS_FLOWER.get().defaultBlockState(), 1))));
        register(context, FLOOR_DEPTHS_CRYSTAL, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.FLOOR_DEPTHS_CRYSTAL_YELLOW.get().defaultBlockState(), 1).add(JBlocks.FLOOR_DEPTHS_CRYSTAL_PINK.get().defaultBlockState(), 1).add(JBlocks.FLOOR_DEPTHS_CRYSTAL_BLUE.get().defaultBlockState(), 1))));
        ...
        register(context, CRYSTAL_DRIPSTONE, JFeatures.CRYSTAL_DRIPSTONE.get(), new SpeleothemClusterConfiguration(JBlocks.CRYSTALLIZED_DRIPSTONE.get().defaultBlockState(),JBlocks.POINTED_CRYSTALLIZED_DRIPSTONE.get().defaultBlockState(), blocks.getOrThrow(JTags.DRIPSTONE_REPLACEABLES), 12, UniformInt.of(3, 6), UniformInt.of(2, 8), 1, 3, UniformInt.of(2, 4), UniformFloat.of(0.3F, 0.7F),  ClampedNormalFloat.of(0.1F, 0.3F, 0.1F, 0.9F), 0.1F, 3, 8));
        ...
        register(context, LIGSHROOM, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.SMALL_LIGSHROOM.get().defaultBlockState(), 1).add(JBlocks.TALL_LIGSHROOM.get().defaultBlockState(), 1))));
        ...
        register(context, LARGE_CHARRED_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.BURNED_BARK.get()), new ForkingTrunkPlacer(5, 5, 5), BlockStateProvider.simple(JBlocks.CHARRED_LEAVES.get()), new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CHARRED_GRASS.get())).build());
        register(context, DYING_BURNED_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.BURNED_BARK.get()), new ForkingTrunkPlacer(2, 1, 1), BlockStateProvider.simple(JBlocks.CHARRED_LEAVES.get()), new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2), new TwoLayersFeatureSize(1, 1, 2)).belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.VOLCANIC_SAND.get())).build());
        register(context, MEDIUM_BURNED_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.BURNED_BARK.get()), new ForkingTrunkPlacer(4, 4, 4), BlockStateProvider.simple(JBlocks.CHARRED_LEAVES.get()), new FancyFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), 2), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CHARRED_GRASS.get())).build());
        register(context, SMALL_BURNED_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.BURNED_BARK.get()), new ForkingTrunkPlacer(3, 3, 3), BlockStateProvider.simple(JBlocks.CHARRED_LEAVES.get()), new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 2), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CHARRED_GRASS.get())).build());
        ...
        register(context, SCORCHED_CACTUS, Feature.BLOCK_COLUMN, new BlockColumnConfiguration(List.of(BlockColumnConfiguration.layer(BiasedToBottomInt.of(1, 5), BlockStateProvider.simple(JBlocks.SCORCHED_CACTUS.get()))), Direction.UP, BlockPredicate.ONLY_IN_AIR_PREDICATE, false));
        register(context, BOIL_PLAINS_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.INFERNO_BUSH.get().defaultBlockState(), 1).add(JBlocks.FLAME_POD.get().defaultBlockState(), 1).add(JBlocks.CRISP_GRASS.get().defaultBlockState(), 1).add(JBlocks.LAVA_BLOOM.get().defaultBlockState(), 1))));
        register(context, CHARRED_FIELDS_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.CHARRED_BRUSH.get().defaultBlockState(), 1).add(JBlocks.CHARRED_SHORT_GRASS.get().defaultBlockState(), 1).add(JBlocks.CHARRED_WEEDS.get().defaultBlockState(), 1).add(JBlocks.TALL_CHARRED_GRASS.get().defaultBlockState(), 1))));
        register(context, BOIL_SANDS_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.TALL_MOLTEN_PLANT.get().defaultBlockState(), 1).add(JBlocks.TALL_CRUMBLING_PINE.get().defaultBlockState(), 1).add(JBlocks.LAVA_BLOOM.get().defaultBlockState(), 1).add(JBlocks.CRUMBLING_PINE.get().defaultBlockState(), 1).add(JBlocks.INFERNO_BUSH.get().defaultBlockState(), 1))));
        register(context, FIRE, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(Blocks.FIRE.defaultBlockState(), 1))));
        register(context, BOIL_UNDERGROWTH, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.SIZZLESHROOM.get().defaultBlockState(), 1).add(JBlocks.TALL_SIZZLESHROOM.get().defaultBlockState(), 1))));

        //FROZEN
        register(context, SMALL_FROZEN_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.FROZEN_LOG.get().defaultBlockState()), new ForkingTrunkPlacer(2, 1, 3), BlockStateProvider.simple(JBlocks.FROZEN_LEAVES.get().defaultBlockState()), new PineFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), ConstantInt.of(2)), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.GRASSY_PERMAFROST.get())).build());
        register(context, MEDIUM_FROZEN_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.FROZEN_LOG.get().defaultBlockState()), new FancyTrunkPlacer(10, 5, 5), BlockStateProvider.simple(JBlocks.FROZEN_LEAVES.get().defaultBlockState()), new PineFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), ConstantInt.of(2)), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.GRASSY_PERMAFROST.get())).decorators(ImmutableList.of(IcyBrushTreeDecorator.INSTANCE, new IceShroomTreeDecorator(0.2F), new CrystalFruitTreeDecorator(4))).build());
        register(context, LARGE_FROZEN_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.FROZEN_LOG.get().defaultBlockState()), new FancyTrunkPlacer(15, 7, 7), BlockStateProvider.simple(JBlocks.FROZEN_LEAVES.get().defaultBlockState()), new PineFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), ConstantInt.of(2)), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CRUMBLED_PERMAFROST.get())).decorators(ImmutableList.of(IcyBrushTreeDecorator.INSTANCE, new IceShroomTreeDecorator(0.2F), new CrystalFruitTreeDecorator(4))).build());
        register(context, LARGE_FROZEN_BITTERWOOD_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.FROZEN_LOG.get().defaultBlockState()), new GiantTrunkPlacer(15, 7, 7), BlockStateProvider.simple(JBlocks.FROZEN_LEAVES.get().defaultBlockState()), new SpruceFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), ConstantInt.of(2)),new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CRUMBLED_PERMAFROST.get())).decorators(ImmutableList.of(new FrozenTreeDecorator(0.01F))).build());
        ...
        register(context, SMALL_FROZEN_BITTERWOOD_TREE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.FROZEN_LOG.get().defaultBlockState()), new StraightTrunkPlacer(4, 2, 3), BlockStateProvider.simple(JBlocks.FROZEN_LEAVES.get().defaultBlockState()), new SpruceFoliagePlacer(ConstantInt.of(3), ConstantInt.of(1), ConstantInt.of(2)), new TwoLayersFeatureSize(1, 1, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.GRASSY_PERMAFROST.get())).decorators(ImmutableList.of(new FrozenTreeDecorator(0.01F))).build());
        ...
        register(context, FROZEN_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.ICE_BUSH.get().defaultBlockState(), 1).add(JBlocks.FROSTBERRY_THORN.get().defaultBlockState(), 1))));
        register(context, FROZEN_FLOWERS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.FROZEN_BLOOM.get().defaultBlockState(), 1).add(JBlocks.CICLEBLOOM.get().defaultBlockState(), 1).add(JBlocks.ICE_BUD.get().defaultBlockState(), 1))));
        ...
        register(context, CORBA_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.CORBA_BLUE_FLOWER.get().defaultBlockState(), 1).add(JBlocks.CORBA_RED_FLOWER.get().defaultBlockState(), 1).add(JBlocks.CORBA_SPECKLED_FLOWER.get().defaultBlockState(), 1).add(JBlocks.CORBA_PURPLE_FLOWER.get().defaultBlockState(), 1).add(JBlocks.CORBA_LIGHT_PURPLE_FLOWER.get().defaultBlockState(), 1).add(JBlocks.CORBA_DARK_PURPLE_FLOWER.get().defaultBlockState(), 1).add(JBlocks.CORBA_FLOWER.get().defaultBlockState(), 1))));
        register(context, CORBA_TALL_GRASS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.CORBA_TALL_GRASS.get().defaultBlockState(), 1))));
        register(context, CORBA_TALL_PLANTS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.BOGWEED.get().defaultBlockState(), 1))));
        register(context, BOGSHROOMS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.SMALL_BOGSHROOM.get().defaultBlockState(), 1).add(JBlocks.TALL_BOGSHROOM.get().defaultBlockState(), 1))));
        register(context, CORBA_RUINS, JFeatures.RUINS.get(), new RuinsFeatureConfig(CORBA_MUD, BlockStateProvider.simple(JBlocks.CORBA_CHEST.get()), new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.CORBA_BRICKS.get().defaultBlockState(), 6).add(JBlocks.CORBA_CRACKED_BRICKS.get().defaultBlockState(), 3).add(JBlocks.CORBA_DARK_BRICKS.get().defaultBlockState(), 4).add(JBlocks.CORBA_LIGHT_BRICKS.get().defaultBlockState(), 3)),5, 5, 8, BuiltInLootTables.ABANDONED_MINESHAFT.identifier()));
        register(context, CORBA_LILY_PAD, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(JBlocks.SWAMP_LILY.get())));
        register(context, CORBA_TREE_SMALL, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.CORBA_LOG.get().defaultBlockState()), new StraightTrunkPlacer(6, 4, 1), BlockStateProvider.simple(JBlocks.CORBA_LEAVES.get().defaultBlockState()), new PineFoliagePlacer(ConstantInt.of(1), ConstantInt.of(1), UniformInt.of(3, 4)), new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CORBA_DIRT.get())).build());
        register(context, CORBA_TREE_MEDIUM, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.CORBA_LOG.get().defaultBlockState()), new ForkingTrunkPlacer(5, 2, 1), BlockStateProvider.simple(JBlocks.CORBA_LEAVES.get().defaultBlockState()), new SpruceFoliagePlacer(UniformInt.of(2, 3), UniformInt.of(0, 2), UniformInt.of(1, 2)), new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CORBA_DIRT.get())).build());
        register(context, CORBA_TREE_LARGE, JFeatures.JTREE.get(), new TreeConfig.JTreeConfigurationBuilder(BlockStateProvider.simple(JBlocks.CORBA_LOG.get().defaultBlockState()), new GiantTrunkPlacer(13, 2, 5), BlockStateProvider.simple(JBlocks.CORBA_LEAVES.get().defaultBlockState()), new MegaPineFoliagePlacer(UniformInt.of(4, 6), UniformInt.of(0, 2), UniformInt.of(13, 17)), new TwoLayersFeatureSize(3, 1, 3)).ignoreVines().belowTrunkProvider(RuleBasedStateProvider.simple(JBlocks.CORBA_DIRT.get())).build());
        register(context, CORBA_SWAMP_TREE, JFeatures.CORBA_SWAMP_TREE.get(), new NoneFeatureConfiguration());

        //TERRANIA
        register(context, TERRANIA_VEG, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.TERRANIAN_FLOWER.get().defaultBlockState(), 1).add(JBlocks.TERRANIAN_TALL_GRASS.get().defaultBlockState(), 1))));
        register(context, TERRANIA_TALL_GRASS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.TERRANIAN_TALL_GRASS.get().defaultBlockState(), 1))));
        register(context, ENCHANTED_SHROOMS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.ENCHANTED_SHROOMS_SMALL.get().defaultBlockState(), 1))));
        register(context, ENCHANTED_SHROOMS_TALL, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.ENCHANTED_SHROOMS_TALL.get().defaultBlockState(), 1))));
        register(context, TALL_TERRAMUSHROOM, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.TALL_TERRAMUSHROOM.get().defaultBlockState(), 1))));
        register(context, SMALL_TERRAMUSHROOM, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(WeightedList.<BlockState>builder().add(JBlocks.TERRAMUSHROOM.get().defaultBlockState(), 1))));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, Identifier.fromNamespaceAndPath(JITL.MOD_ID, name));
    }
