...
public class JRecipeProvider extends RecipeProvider {
    ...
    protected void threeByThreePacker(@NotNull RecipeOutput pRecipeOutput, @NotNull RecipeCategory pCategory, ItemLike pPacked, @NotNull ItemLike pUnpacked, @NotNull String pCriterionName) {
        ShapelessRecipeBuilder.shapeless(items, pCategory, pPacked).requires(pUnpacked, 9).unlockedBy(pCriterionName, has(pUnpacked)).save(pRecipeOutput);
    }
