...
public class JTorchBlockGenerator extends BasicFileGenerator {

    protected BufferedWriter blockModelWriter, blockstateWriter, itemModelWriter;

    public void generate() {
        for(String name : JBlocks.torchBlockName) {
    ...
    public void getBlockModel(String modID, String name) {
        ...
        writeToBlockModelFile("  \"parent\": \"minecraft:block/template_torch\",");
